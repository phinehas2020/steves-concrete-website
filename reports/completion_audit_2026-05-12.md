...
| EXIF GPS where photo permits | `reports/image_gps_rescan_2026-05-12.md`; `reports/image_gps_located_files_manifest_2026-05-12.md`; `reports/image_exif_gps_scan_2026-05-12.md`; `reports/image_exif_gps_scan_2026-05-12.json`; `reports/image_gps_permission_form_2026-05-12.md`; corrected `mdls` rescan found 24 of 87 files with macOS latitude/longitude metadata; filename manifest lists the 24 located files without repeating precise coordinates; no owner permission/source policy available for retaining, stripping, normalizing, or adding GPS metadata; tracked in GitHub issue `#9` | Blocked by permission/privacy policy |
