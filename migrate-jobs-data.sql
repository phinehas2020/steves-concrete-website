-- Migration script to insert all current jobs into new Supabase
-- This includes all 16 jobs with their images
...
-- Insert images for each job (using the same logic as before)
DO $$
DECLARE
  job_record RECORD;
  img_num INTEGER;
